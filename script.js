...
const prototypeAnswers = {
  ...
  evaluation: {
    ...
    body: "Evidence includes 92% ROC-AUC on author-style detection, 96% speaker diarization accuracy, a 5x pipeline improvement, and calibrated risk modeling.",
...
function renderAnswer(question) {
  ...
  ragOutput.innerHTML = `
    <div class="answer-header">
      ...
      <div><strong>${answer.title}</strong><small>Simulated retrieval complete / 3 passages reranked</small></div>
    </div>
...
function renderApiAnswer(result) {
  ...
  ragOutput.innerHTML = `
    <div class="answer-header">
      ...
      <div><strong>Grounded answer / ${result.confidence} confidence</strong><small>Hybrid retrieval complete / ${result.latency_ms}ms</small></div>
    </div>
...
function renderConversation() {
  ...
  `).join("") : `<p>No conversation yet. Ask a recruiter question to begin.</p>`;
}
...
async function queryRag(question) {
  ...
  ragOutput.innerHTML = `
    <div class="answer-header">
      <span class="answer-icon">AI</span>
      <div><strong>Retrieving evidence...</strong><small>Running hybrid search and reranking</small></div>
    </div>
    <div class="pipeline-steps"><span>Query</span><i></i><span>Hybrid search</span><i></i><span>Rerank</span><i></i><span>Generate + cite</span></div>
  `;
...
clearConversation.addEventListener("click", () => {
  ...
  ragOutput.innerHTML = `<div class="answer-header"><span class="answer-icon">AI</span><div><strong>Conversation cleared</strong><small>Ask a new recruiter question to begin again.</small></div></div>`;
});
